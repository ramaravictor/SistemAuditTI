        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold leading-tight text-gray-900 dark:text-gray-100">
                    {{ __('Tambah Level Baru') }}
                </h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Buat level baru untuk kategori yang sudah ada
                </p>
            </div>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow-xl rounded-xl dark:bg-gray-800">
                <div class="px-6 py-8 sm:px-8">
                    <div class="mb-8">
                        <div
                            class="flex items-center justify-center w-16 h-16 mx-auto bg-blue-100 rounded-full dark:bg-blue-900">
                        ...
                        <p class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">
                            Lengkapi informasi berikut untuk membuat level baru
                        </p>
                    </div>

                    <form action="{{ route('level.store') }}" method="POST" class="space-y-6">
                        @csrf
            ...
            <!-- Help Card -->
            <div class="mt-6 overflow-hidden shadow-sm bg-blue-50 rounded-xl dark:bg-blue-900/20">
                <div class="px-6 py-4">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                                <ul class="space-y-1 list-disc list-inside">
                                    <li>Nama level harus jelas dan mudah dipahami</li>
                                    <li>Pastikan memilih kategori yang sesuai</li>
                                    <li>Nomor level menentukan urutan dari yang termudah ke tersulit</li>

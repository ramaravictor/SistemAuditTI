...
<div class="mt-6 p-4 text-sm rounded-lg text-amber-700 bg-amber-100 dark:bg-amber-600/20 dark:text-amber-300 border border-amber-500/40 {{-- animate-fadeInDown (jika dianimasikan) --}}" role="alert">
   <span class="font-bold">Perhatian!</span> Data profil Anda belum lengkap. Mohon lengkapi Nomor HP, Nama Perusahaan, dan Bagian Unit Kerja untuk fungsionalitas penuh.
</div>
@endif
{{-- Akhir Notifikasi --}}
</header>
...
@if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
   <div class="mt-3">
       <p class="text-sm text-gray-700 dark:text-gray-300">
           ...
           <button form="send-verification" class="underline text-sm text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-200 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 dark:focus:ring-offset-slate-800 transition-colors duration-150">

<x-admin-layout>
    ...
    <div class="py-12 dark:bg-slate-950">
        <div class="mx-auto space-y-8 max-w-7xl sm:px-6 lg:px-8">
            ...
            <div
                class="p-4 bg-white shadow-xl sm:p-8 dark:bg-slate-800/70 dark:backdrop-blur-md dark:shadow-blue-950/40 sm:rounded-xl dark:border dark:border-blue-700/30 animate-fadeInUp">
                <div class="max-w-xl">
            ...
            <div class="p-4 bg-white shadow-xl sm:p-8 dark:bg-slate-800/70 dark:backdrop-blur-md dark:shadow-blue-950/40 sm:rounded-xl dark:border dark:border-blue-700/30 animate-fadeInUp animation-delay-100"
                style="opacity:0;">
                <div class="max-w-xl">
            ...
            {{-- Panel Hapus Akun --}}
            <div class="p-4 bg-white shadow-xl sm:p-8 dark:bg-slate-800/70 dark:backdrop-blur-md dark:shadow-red-950/40 sm:rounded-xl dark:border dark:border-red-700/30 animate-fadeInUp animation-delay-200"
                style="opacity:0;">
                <div class="max-w-xl">
